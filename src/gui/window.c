...
{
    PMAINWIN pWin = (PMAINWIN)hWnd;
    printf("Pre Def Main Win Proc hWnd %ld message %d wParam %ld lParam %ld \n",hWnd,message,wParam,lParam);
...
{
    printf("Pre Def Control  Proc hWnd %ld message %d wParam %ld lParam %ld \n",hWnd,message,wParam,lParam);
...
{
    printf("Pre Def Win Proc hWnd %ld message %d wParam %ld lParam %ld \n",hWnd,message,wParam,lParam);
        ...
        DWORD dwAddData)
{
    ...
    SendMessage (HWND_DESKTOP, 
            MSG_GETCTRLCLASSINFO, &cci, (LPARAM)spClassName);
